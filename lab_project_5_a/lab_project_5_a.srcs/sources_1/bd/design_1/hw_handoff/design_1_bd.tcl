...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A1_1 [get_bd_ports A1] [get_bd_pins xup_and2_4/b] [get_bd_pins xup_and2_6/b] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net A2_1 [get_bd_ports A2] [get_bd_pins xup_and2_4/a] [get_bd_pins xup_and2_7/a] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net EN_1 [get_bd_ports EN] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_and2_3/a]
  connect_bd_net -net xup_and2_0_y [get_bd_ports D0] [get_bd_pins xup_and2_0/y]
  connect_bd_net -net xup_and2_1_y [get_bd_ports D1] [get_bd_pins xup_and2_1/y]
  connect_bd_net -net xup_and2_2_y [get_bd_ports D2] [get_bd_pins xup_and2_2/y]
  connect_bd_net -net xup_and2_3_y [get_bd_ports D3] [get_bd_pins xup_and2_3/y]
  connect_bd_net -net xup_and2_4_y [get_bd_pins xup_and2_3/b] [get_bd_pins xup_and2_4/y]
  connect_bd_net -net xup_and2_5_y [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_5/y]
  connect_bd_net -net xup_and2_6_y [get_bd_pins xup_and2_1/b] [get_bd_pins xup_and2_6/y]
  connect_bd_net -net xup_and2_7_y [get_bd_pins xup_and2_2/b] [get_bd_pins xup_and2_7/y]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_5/a] [get_bd_pins xup_and2_6/a] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and2_5/b] [get_bd_pins xup_and2_7/b] [get_bd_pins xup_inv_1/y]
