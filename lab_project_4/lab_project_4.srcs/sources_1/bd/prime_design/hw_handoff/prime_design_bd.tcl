...
################################################################
# This is a generated script based on design: prime_design
#
...
# source prime_design_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A1_1 [get_bd_ports A1] [get_bd_pins xup_and3_0/c] [get_bd_pins xup_inv_2/a]
  connect_bd_net -net A2_1 [get_bd_ports A2] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and3_0/b] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net A3_1 [get_bd_ports A3] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_and3_0/a]
  connect_bd_net -net xup_and2_0_y [get_bd_pins xup_and2_0/y] [get_bd_pins xup_or4_0/b]
  connect_bd_net -net xup_and2_1_y [get_bd_pins xup_and2_1/y] [get_bd_pins xup_or4_0/a]
  connect_bd_net -net xup_and2_2_y [get_bd_pins xup_and2_2/y] [get_bd_pins xup_or4_0/c]
  connect_bd_net -net xup_and3_0_y [get_bd_pins xup_and3_0/y] [get_bd_pins xup_or4_0/d]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_2/b] [get_bd_pins xup_inv_0/y]
  ...
  connect_bd_net -net xup_or4_0_y [get_bd_ports O] [get_bd_pins xup_or4_0/y]
