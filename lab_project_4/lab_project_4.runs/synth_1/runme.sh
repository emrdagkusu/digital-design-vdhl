...
HD_PWD='C:/Users/E.D/AppData/Roaming/Xilinx/Vivado/lab_project_4/lab_project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prime_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prime_design_wrapper.tcl
