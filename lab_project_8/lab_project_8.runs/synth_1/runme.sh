...
HD_PWD='C:/Users/E.D/lab_project_8/lab_project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_lab_8_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_lab_8_wrapper.tcl
