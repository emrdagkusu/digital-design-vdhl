...
#
# Generated by export_simulation on Fri Jan 08 01:13:57 +0300 2021
#
################################################################################
...
'-reset_run' switch to the './project_design_1.sh' script.

./project_design_1.sh -reset_run
...
./project_design_1.sh -noclean_files

For more information on the script, please type './project_design_1.sh -help'.
