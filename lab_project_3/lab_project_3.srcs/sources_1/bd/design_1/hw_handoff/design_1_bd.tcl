...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins xup_nand2_0/a] [get_bd_pins xup_nor2_0/a]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins xup_nand2_0/b] [get_bd_pins xup_nor2_0/b]
  connect_bd_net -net xup_nand2_0_y [get_bd_pins xup_nand2_0/y] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net xup_nor2_0_y [get_bd_pins xup_nor2_0/y] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net xup_xor2_0_y [get_bd_ports E] [get_bd_pins xup_xor2_0/y]
